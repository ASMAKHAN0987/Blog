...
<nav>
  ...
  <ul id="navlinks">
    ...
    <li><a href="<?= ROOT_URL ?>index.php">Home</a><span class="line"></span></li>
    ...
    <?php if (isset($_SESSION['user_id']) && isset($_SESSION['expires']) && $_SESSION['expires'] > time()) : ?>
        <li class="nav-profile">
          <div class="avatar"><img src="<?= $setImg ?>" alt="" class="rounded-5"></div>
          <ul class="avatar-part-con hide">
            <li><a href="admin/dashboard.php" class="text-black fw-bold">Dashboard</a></li>
